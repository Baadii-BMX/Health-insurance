...
def chat():
    ...
    try:
        ...
        if "дэвтэргүй" in message_lower or "дэвтэр" in message_lower:
            ...
            return jsonify({'text': "ЭМД-ын хөнгөлөлттэй эмийн жагсаалтын дагуу 2025 онд дараах төрлийн эмүүд хамрагдана: 1) Зүрх судасны өвчний эмүүд - 50-70% хөнгөлөлттэй, 2) Чихрийн шижин өвчний эмүүд - 80% хөнгөлөлттэй, 3) Астма, уушгины архаг бөглөрөлт өвчний эмүүд - 80-90% хөнгөлөлттэй, 4) Халдварт өвчний эмүүд - 30-50% хөнгөлөлттэй, 5) Сэтгэцийн эмгэгийн эмүүд - 90% хөнгөлөлттэй, 6) Хавдрын эмүүд - 80-100%, 7) Ходоод гэдэсний замын эмүүд - 50% хөнгөлөлттэй, 8) Өвдөлт намдаах эмүүд - 40-50% хөнгөлөлттэй."})
